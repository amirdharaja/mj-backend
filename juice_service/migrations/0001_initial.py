# Generated by Django 2.2.14 on 2020-09-11 10:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count_per_week', models.IntegerField(validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(7)])),
                ('rate_per_bottle', models.FloatField()),
                ('rate_per_week', models.FloatField(editable=False)),
                ('discount_type', models.CharField(choices=[('0', 'No discount'), ('%', '%'), ('₹', '₹'), ('w', 'w')], default='0', max_length=1)),
